    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(9222), null, "The generated Lorem Ipsum is therefore always free from repetition injected humour, or non-characteristic words etc.", "/WebT/img/baner-1.png", false, null, "1", "50", true, "in Our Store", "Fresh Exotic Fruits", "#", "BUY" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Fruites", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7714), null, false, null, true },
                    { 2, "Vesitables", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7717), null, false, null, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "20%", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(8971), null, "OFF", "/WebT/img/featur-1.jpg", false, null, true, "Fresh Apples" },
                    { 2, "", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(8974), null, "Free delivery", "/WebT/img/featur-2.jpg", false, null, true, "Tasty Fruits" },
                    { 3, "30$", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(9061), null, "Discount", "/WebT/img/featur-3.jpg", false, null, true, "Exotic Vegitable" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(9194), null, "1963", "fa fa-users text-secondary", false, null, true, "SATISFIED CUSTOMERS" },
                    { 2, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(9196), null, "99%", "fa fa-users text-secondary", false, null, true, "QUALITY OF SERVICE" },
                    { 3, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(9197), null, "33", "fa fa-users text-secondary", false, null, true, "QUALITY CERTIFICATES" },
                    { 4, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(9198), null, "789", "fa fa-users text-secondary", false, null, true, "AVAILABLE PRODUCTS" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(9166), null, "Free on order over $300", "fas fa-car-side fa-3x text-white", false, null, true, "Free Shipping" },
                    { 2, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(9168), null, "100% security payment", "fas fa-user-shield fa-3x text-white", false, null, true, "Security Payment" },
                    { 3, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(9170), null, "30 day money guarantee", "fas fa-exchange-alt fa-3x text-white", false, null, true, "30 Day Return" },
                    { 4, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(9172), null, "Support every time fast", "fa fa-phone-alt fa-3x text-white", false, null, true, "24/7 Support" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7659), null, false, null, "Admin", true },
                    { 2, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7695), null, false, null, "User", true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(8949), null, "Organic Veggies & Fruits Foods", "/WebT/img/hero-img-1.png", "/WebT/img/hero-img-2.jpg", false, "Fruites", "Vesitables", null, true, "100% Organic Foods", "#", "#" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(8916), null, "fab fa-facebook-f", false, null, true, "Facebook", "http://www.facebook.com" },
                    { 2, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(8918), null, "fab fa-youtube", false, null, true, "Youtube", "http://www.youtube.com" },
                    { 3, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(8920), null, "fab fa-linkedin-in", false, null, true, "Linkedin", "http://www.linkedin.com" },
                    { 4, "btn btn-outline-secondary btn-md-square rounded-circle", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(8922), null, "fab fa-twitter", false, null, true, "Twitter", "http://www.x.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(8891), null, "/WebT/img/testimonial-1.jpg", false, null, "Şebnem Ferah", true, "Şef Aşçı" },
                    { 2, "Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(8894), null, "/WebT/img/testimonial-1.jpg", false, null, "Teoman Yakupoğlu", true, "Şef Aşçı" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7741), null, false, null, true, "Grapes" },
                    { 2, 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7744), null, false, null, true, "Raspberries" },
                    { 3, 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7745), null, false, null, true, "Apricots" },
                    { 4, 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7747), null, false, null, true, "Banana" },
                    { 5, 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7748), null, false, null, true, "Oranges" },
                    { 6, 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7751), null, false, null, true, "Apple" },
                    { 7, 2, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7752), null, false, null, true, "Patatoes" },
                    { 8, 2, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7753), null, false, null, true, "Persely" },
                    { 9, 2, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7755), null, false, null, true, "Tomato" },
                    { 10, 2, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7757), null, false, null, true, "Brocoli" },
                    { 11, 2, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7758), null, false, null, true, "Bell Papper" },
                    { 12, 1, new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(7759), null, false, null, true, "Strawberry" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Ankara", new DateTime(2024, 5, 8, 18, 2, 43, 741, DateTimeKind.Local).AddTicks(8837), null, "x", "admin@test.com", "Şebnem", false, "Ferah", null, "CfDJ8Lhzc99II2tHnoigxoZuezPe4fpNXpWW1XYIxkzbtSLn23yrRsB0w-8QiLdl1HwBUdAsSWjtDR7BTHG3aY-epQbqNcu8hW1hPXhCA_71ije_YFl9wEcgi6KvFW67FfLO3g", "0850", 1, true, "Admin" });
