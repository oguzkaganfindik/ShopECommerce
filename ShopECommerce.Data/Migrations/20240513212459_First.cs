    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(542), null, "The generated Lorem Ipsum is therefore always free from repetition injected humour, or non-characteristic words etc.", "/WebT/img/baner-1.png", false, null, "1", "50", true, "in Our Store", "Fresh Exotic Fruits", "/Shop/Index/", "BUY" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Fruites", new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8720), null, false, null, true },
                    { 2, "Vesitables", new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8723), null, false, null, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "20%", new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(329), null, "OFF", "/WebT/img/featur-1.jpg", false, null, true, "Fresh Apples" },
                    { 2, "", new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(332), null, "Free delivery", "/WebT/img/featur-2.jpg", false, null, true, "Tasty Fruits" },
                    { 3, "30$", new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(333), null, "Discount", "/WebT/img/featur-3.jpg", false, null, true, "Exotic Vegitable" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(510), null, "1963", "fa fa-users text-secondary", false, null, true, "SATISFIED CUSTOMERS" },
                    { 2, new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(513), null, "99%", "fa fa-users text-secondary", false, null, true, "QUALITY OF SERVICE" },
                    { 3, new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(514), null, "33", "fa fa-users text-secondary", false, null, true, "QUALITY CERTIFICATES" },
                    { 4, new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(515), null, "789", "fa fa-users text-secondary", false, null, true, "AVAILABLE PRODUCTS" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(476), null, "Free on order over $300", "fas fa-car-side fa-3x text-white", false, null, true, "Free Shipping" },
                    { 2, new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(479), null, "100% security payment", "fas fa-user-shield fa-3x text-white", false, null, true, "Security Payment" },
                    { 3, new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(481), null, "30 day money guarantee", "fas fa-exchange-alt fa-3x text-white", false, null, true, "30 Day Return" },
                    { 4, new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(482), null, "Support every time fast", "fa fa-phone-alt fa-3x text-white", false, null, true, "24/7 Support" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8585), null, false, null, "Admin", true },
                    { 2, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8686), null, false, null, "User", true },
                    { 3, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8703), null, false, null, "Customer", true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(303), null, "Organic Veggies & Fruits Foods", "/WebT/img/hero-img-1.png", "/WebT/img/hero-img-2.jpg", false, "Fruites", "Vesitables", null, true, "100% Organic Foods", "#", "#" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(269), null, "fab fa-facebook-f", false, null, true, "Facebook", "http://www.facebook.com" },
                    { 2, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(272), null, "fab fa-youtube", false, null, true, "Youtube", "http://www.youtube.com" },
                    { 3, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(274), null, "fab fa-linkedin-in", false, null, true, "Linkedin", "http://www.linkedin.com" },
                    { 4, "btn btn-outline-secondary btn-md-square rounded-circle", new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(275), null, "fab fa-twitter", false, null, true, "Twitter", "http://www.x.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,", new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(242), null, "/WebT/img/testimonial-1.jpg", false, null, "Şebnem Ferah", true, "Şef Aşçı" },
                    { 2, "Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,", new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(246), null, "/WebT/img/testimonial-1.jpg", false, null, "Teoman Yakupoğlu", true, "Şef Aşçı" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8753), null, false, null, true, "Grapes" },
                    { 2, 1, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8755), null, false, null, true, "Raspberries" },
                    { 3, 1, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8757), null, false, null, true, "Apricots" },
                    { 4, 1, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8758), null, false, null, true, "Banana" },
                    { 5, 1, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8759), null, false, null, true, "Oranges" },
                    { 6, 1, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8762), null, false, null, true, "Apple" },
                    { 7, 2, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8764), null, false, null, true, "Patatoes" },
                    { 8, 2, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8793), null, false, null, true, "Persely" },
                    { 9, 2, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8794), null, false, null, true, "Tomato" },
                    { 10, 2, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8796), null, false, null, true, "Brocoli" },
                    { 11, 2, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8798), null, false, null, true, "Bell Papper" },
                    { 12, 1, new DateTime(2024, 5, 14, 0, 24, 57, 931, DateTimeKind.Local).AddTicks(8800), null, false, null, true, "Strawberry" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Ankara", null, null, new DateTime(2024, 5, 14, 0, 24, 57, 932, DateTimeKind.Local).AddTicks(180), null, "x", "admin@test.com", false, "Şebnem", false, "Ferah", null, null, "CfDJ8Lhzc99II2tHnoigxoZuezNCZZU20PZ0zplaqliBYLhaZYoznsF_D95DGRq9FM6bxAZS4GYzdKU4ZonJ9PVVjFC-4pWx98swoop9EB_8uovHFhWhDdZSw7demu_TUwbdog", "0850", null, 1, true, new Guid("603fbd51-dfa0-4f92-a0a0-057a2184e915"), "Admin" });
