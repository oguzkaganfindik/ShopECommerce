    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4755), null, "The generated Lorem Ipsum is therefore always free from repetition injected humour, or non-characteristic words etc.", "/WebT/img/baner-1.png", false, null, "1", "50", true, "in Our Store", "Fresh Exotic Fruits", "#", "BUY" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Fruites", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3145), null, false, null, true },
                    { 2, "Vesitables", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3148), null, false, null, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "20%", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4520), null, "OFF", "/WebT/img/featur-1.jpg", false, null, true, "Fresh Apples" },
                    { 2, "", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4523), null, "Free delivery", "/WebT/img/featur-2.jpg", false, null, true, "Tasty Fruits" },
                    { 3, "30$", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4524), null, "Discount", "/WebT/img/featur-3.jpg", false, null, true, "Exotic Vegitable" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4720), null, "1963", "fa fa-users text-secondary", false, null, true, "SATISFIED CUSTOMERS" },
                    { 2, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4722), null, "99%", "fa fa-users text-secondary", false, null, true, "QUALITY OF SERVICE" },
                    { 3, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4724), null, "33", "fa fa-users text-secondary", false, null, true, "QUALITY CERTIFICATES" },
                    { 4, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4726), null, "789", "fa fa-users text-secondary", false, null, true, "AVAILABLE PRODUCTS" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4689), null, "Free on order over $300", "fas fa-car-side fa-3x text-white", false, null, true, "Free Shipping" },
                    { 2, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4692), null, "100% security payment", "fas fa-user-shield fa-3x text-white", false, null, true, "Security Payment" },
                    { 3, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4694), null, "30 day money guarantee", "fas fa-exchange-alt fa-3x text-white", false, null, true, "30 Day Return" },
                    { 4, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4696), null, "Support every time fast", "fa fa-phone-alt fa-3x text-white", false, null, true, "24/7 Support" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3085), null, false, null, "Admin", true },
                    { 2, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3126), null, false, null, "User", true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4491), null, "Organic Veggies & Fruits Foods", "/WebT/img/hero-img-1.png", "/WebT/img/hero-img-2.jpg", false, "Fruites", "Vesitables", null, true, "100% Organic Foods", "#", "#" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4456), null, "fab fa-facebook-f", false, null, true, "Facebook", "http://www.facebook.com" },
                    { 2, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4458), null, "fab fa-youtube", false, null, true, "Youtube", "http://www.youtube.com" },
                    { 3, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4460), null, "fab fa-linkedin-in", false, null, true, "Linkedin", "http://www.linkedin.com" },
                    { 4, "btn btn-outline-secondary btn-md-square rounded-circle", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4462), null, "fab fa-twitter", false, null, true, "Twitter", "http://www.x.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4426), null, "/WebT/img/testimonial-1.jpg", false, null, "Şebnem Ferah", true, "Şef Aşçı" },
                    { 2, "Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4430), null, "/WebT/img/testimonial-1.jpg", false, null, "Teoman Yakupoğlu", true, "Şef Aşçı" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3177), null, false, null, true, "Grapes" },
                    { 2, 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3179), null, false, null, true, "Raspberries" },
                    { 3, 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3181), null, false, null, true, "Apricots" },
                    { 4, 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3182), null, false, null, true, "Banana" },
                    { 5, 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3183), null, false, null, true, "Oranges" },
                    { 6, 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3186), null, false, null, true, "Apple" },
                    { 7, 2, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3188), null, false, null, true, "Patatoes" },
                    { 8, 2, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3189), null, false, null, true, "Persely" },
                    { 9, 2, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3190), null, false, null, true, "Tomato" },
                    { 10, 2, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3193), null, false, null, true, "Brocoli" },
                    { 11, 2, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3194), null, false, null, true, "Bell Papper" },
                    { 12, 1, new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(3195), null, false, null, true, "Strawberry" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Ankara", new DateTime(2024, 5, 9, 17, 53, 34, 638, DateTimeKind.Local).AddTicks(4369), null, "x", "admin@test.com", "Şebnem", false, "Ferah", null, "CfDJ8Lhzc99II2tHnoigxoZuezOXYewO2WtaZY6uaUQDdASRTZGIzTyd04yEjOtY0Ab-490MRK-VV9VrkI-nTlZGlyyvwYzk1aM0I5iTsFUao7alnkhSmQ8iqtrHiYYKny4rfA", "0850", 1, true, "Admin" });
