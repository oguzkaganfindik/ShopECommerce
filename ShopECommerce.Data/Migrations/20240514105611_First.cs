    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(418), null, "The generated Lorem Ipsum is therefore always free from repetition injected humour, or non-characteristic words etc.", "/WebT/img/baner-1.png", false, null, "1", "50", true, "in Our Store", "Fresh Exotic Fruits", "/Shop/Index/", "BUY" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Fruites", new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8797), null, false, null, true },
                    { 2, "Vesitables", new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8800), null, false, null, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "20%", new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(151), null, "OFF", "/WebT/img/featur-1.jpg", false, null, true, "Fresh Apples" },
                    { 2, "", new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(153), null, "Free delivery", "/WebT/img/featur-2.jpg", false, null, true, "Tasty Fruits" },
                    { 3, "30$", new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(156), null, "Discount", "/WebT/img/featur-3.jpg", false, null, true, "Exotic Vegitable" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(391), null, "1963", "fa fa-users text-secondary", false, null, true, "SATISFIED CUSTOMERS" },
                    { 2, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(393), null, "99%", "fa fa-users text-secondary", false, null, true, "QUALITY OF SERVICE" },
                    { 3, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(394), null, "33", "fa fa-users text-secondary", false, null, true, "QUALITY CERTIFICATES" },
                    { 4, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(395), null, "789", "fa fa-users text-secondary", false, null, true, "AVAILABLE PRODUCTS" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(360), null, "Free on order over $300", "fas fa-car-side fa-3x text-white", false, null, true, "Free Shipping" },
                    { 2, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(363), null, "100% security payment", "fas fa-user-shield fa-3x text-white", false, null, true, "Security Payment" },
                    { 3, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(364), null, "30 day money guarantee", "fas fa-exchange-alt fa-3x text-white", false, null, true, "30 Day Return" },
                    { 4, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(365), null, "Support every time fast", "fa fa-phone-alt fa-3x text-white", false, null, true, "24/7 Support" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8685), null, false, null, "Admin", true },
                    { 2, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8765), null, false, null, "User", true },
                    { 3, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8781), null, false, null, "Customer", true }
                });

            migrationBuilder.InsertData(
                table: "ShopTables",
                columns: new[] { "Id", "CreatedDate", "DeletedDate", "IsDeleted", "ModifiedDate", "Name", "OrderId", "Status" },
                values: new object[] { 1, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(174), null, false, null, "Musteri", 1, true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(125), null, "Organic Veggies & Fruits Foods", "/WebT/img/hero-img-1.png", "/WebT/img/hero-img-2.jpg", false, "Fruites", "Vesitables", null, true, "100% Organic Foods", "#", "#" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(93), null, "fab fa-facebook-f", false, null, true, "Facebook", "http://www.facebook.com" },
                    { 2, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(96), null, "fab fa-youtube", false, null, true, "Youtube", "http://www.youtube.com" },
                    { 3, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(97), null, "fab fa-linkedin-in", false, null, true, "Linkedin", "http://www.linkedin.com" },
                    { 4, "btn btn-outline-secondary btn-md-square rounded-circle", new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(99), null, "fab fa-twitter", false, null, true, "Twitter", "http://www.x.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,", new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(69), null, "/WebT/img/testimonial-1.jpg", false, null, "Şebnem Ferah", true, "Şef Aşçı" },
                    { 2, "Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,", new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(72), null, "/WebT/img/testimonial-1.jpg", false, null, "Teoman Yakupoğlu", true, "Şef Aşçı" }
                });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "CreatedDate", "DeletedDate", "Description", "IsDeleted", "ModifiedDate", "OrderDate", "ShopTableId", "Status", "TotalPrice" },
                values: new object[] { 1, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(217), null, "Siparis", false, null, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(216), 1, true, 200m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8823), null, false, null, true, "Grapes" },
                    { 2, 1, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8826), null, false, null, true, "Raspberries" },
                    { 3, 1, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8827), null, false, null, true, "Apricots" },
                    { 4, 1, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8828), null, false, null, true, "Banana" },
                    { 5, 1, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8829), null, false, null, true, "Oranges" },
                    { 6, 1, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8834), null, false, null, true, "Apple" },
                    { 7, 2, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8835), null, false, null, true, "Patatoes" },
                    { 8, 2, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8836), null, false, null, true, "Persely" },
                    { 9, 2, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8837), null, false, null, true, "Tomato" },
                    { 10, 2, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8839), null, false, null, true, "Brocoli" },
                    { 11, 2, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8840), null, false, null, true, "Bell Papper" },
                    { 12, 1, new DateTime(2024, 5, 14, 13, 56, 9, 187, DateTimeKind.Local).AddTicks(8842), null, false, null, true, "Strawberry" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Ankara", null, null, new DateTime(2024, 5, 14, 13, 56, 9, 188, DateTimeKind.Local).AddTicks(8), null, "x", "admin@test.com", false, "Şebnem", false, "Ferah", null, null, "CfDJ8AFnJuxD-_dDov0aPJ54hjeVTwm9IGnIkJ2Cvhi0cFGHeV_-Gg1519BPkgCL_XEtfEQhIN82IvEgjRnTywAfemL4nf6LkLybwLQ81BYrbb0SqC6q66WavpUWgA0wllMKoA", "0850", null, 1, true, new Guid("1b3efff4-743a-487d-ae95-97882c1432e9"), "Admin" });
