        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_ShopTables_ShopTableId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7602), null, "The generated Lorem Ipsum is therefore always free from repetition injected humour, or non-characteristic words etc.", "/WebT/img/baner-1.png", false, null, "1", "50", true, "in Our Store", "Fresh Exotic Fruits", "/Shop/Index/", "BUY" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Fruites", new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6472), null, false, null, true },
                    { 2, "Vesitables", new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6474), null, false, null, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "20%", new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7277), null, "OFF", "/WebT/img/featur-1.jpg", false, null, true, "Fresh Apples" },
                    { 2, "", new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7279), null, "Free delivery", "/WebT/img/featur-2.jpg", false, null, true, "Tasty Fruits" },
                    { 3, "30$", new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7280), null, "Discount", "/WebT/img/featur-3.jpg", false, null, true, "Exotic Vegitable" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7570), null, "1963", "fa fa-users text-secondary", false, null, true, "SATISFIED CUSTOMERS" },
                    { 2, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7573), null, "99%", "fa fa-users text-secondary", false, null, true, "QUALITY OF SERVICE" },
                    { 3, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7575), null, "33", "fa fa-users text-secondary", false, null, true, "QUALITY CERTIFICATES" },
                    { 4, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7576), null, "789", "fa fa-users text-secondary", false, null, true, "AVAILABLE PRODUCTS" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7464), null, "Free on order over $300", "fas fa-car-side fa-3x text-white", false, null, true, "Free Shipping" },
                    { 2, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7467), null, "100% security payment", "fas fa-user-shield fa-3x text-white", false, null, true, "Security Payment" },
                    { 3, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7468), null, "30 day money guarantee", "fas fa-exchange-alt fa-3x text-white", false, null, true, "30 Day Return" },
                    { 4, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7469), null, "Support every time fast", "fa fa-phone-alt fa-3x text-white", false, null, true, "24/7 Support" }
                });

            migrationBuilder.InsertData(
                table: "Notifications",
                columns: new[] { "Id", "CreatedDate", "DeletedDate", "Description", "Icon", "IsDeleted", "ModifiedDate", "Status", "Type" },
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7653), null, "Yeni Siparişiniz Var", "la la-user-plus", false, null, true, "notif-icon notif-primary" },
                    { 2, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7655), null, "Yeni Mesajınız Var", "la la-comment", false, null, true, "notif-icon notif-success" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6361), null, false, null, "Admin", true },
                    { 2, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6441), null, false, null, "User", true },
                    { 3, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6456), null, false, null, "Customer", true }
                });

            migrationBuilder.InsertData(
                table: "ShopTables",
                columns: new[] { "Id", "CreatedDate", "DeletedDate", "IsDeleted", "ModifiedDate", "Name", "OrderId", "Status" },
                values: new object[] { 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7301), null, false, null, "Musteri", 1, true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7252), null, "Organic Veggies & Fruits Foods", "/WebT/img/hero-img-1.png", "/WebT/img/hero-img-2.jpg", false, "Fruites", "Vesitables", null, true, "100% Organic Foods", "#", "#" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7221), null, "fab fa-facebook-f", false, null, true, "Facebook", "http://www.facebook.com" },
                    { 2, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7224), null, "fab fa-youtube", false, null, true, "Youtube", "http://www.youtube.com" },
                    { 3, "btn btn-outline-secondary me-2 btn-md-square rounded-circle", new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7225), null, "fab fa-linkedin-in", false, null, true, "Linkedin", "http://www.linkedin.com" },
                    { 4, "btn btn-outline-secondary btn-md-square rounded-circle", new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7227), null, "fab fa-twitter", false, null, true, "Twitter", "http://www.x.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,", new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7167), null, "/WebT/img/client1.jpg", false, null, "Şebnem Ferah", true, "Şef Aşçı" },
                    { 2, "Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,", new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7169), null, "/WebT/img/client2.jpg", false, null, "Teoman Yakupoğlu", true, "Şef Aşçı" }
                });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "CreatedDate", "DeletedDate", "Description", "IsDeleted", "ModifiedDate", "OrderDate", "ShopTableId", "Status", "TotalPrice" },
                values: new object[] { 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7345), null, "Siparis", false, null, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7344), 1, true, 200m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6498), null, false, null, true, "Grapes" },
                    { 2, 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6500), null, false, null, true, "Raspberries" },
                    { 3, 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6501), null, false, null, true, "Apricots" },
                    { 4, 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6503), null, false, null, true, "Banana" },
                    { 5, 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6504), null, false, null, true, "Oranges" },
                    { 6, 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6508), null, false, null, true, "Apple" },
                    { 7, 2, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6509), null, false, null, true, "Patatoes" },
                    { 8, 2, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6511), null, false, null, true, "Persely" },
                    { 9, 2, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6512), null, false, null, true, "Tomato" },
                    { 10, 2, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6514), null, false, null, true, "Brocoli" },
                    { 11, 2, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6515), null, false, null, true, "Bell Papper" },
                    { 12, 1, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6516), null, false, null, true, "Strawberry" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ankara", null, null, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(6951), null, "User Onaylandı.", "admin@test.com", true, "Sezen", false, "Aksu", null, null, "CfDJ8Og5fv4kqcJInWpt0PuNFrpK8_sStlLJXbAIO481AYNR77HFoanf4005z9pShd1UnjLp6RykpPCeJN5ciqqX-86ypmOmn5EACExWjfJ-aZiBixr6-wj1CBC25Px2A2s8lQ", "0850", null, 1, true, new Guid("35652561-1d06-4bf2-8317-e2dd66cb4f1f"), "SezenAksu" },
                    { 2, "Ankara", null, null, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7051), null, "User Onaylandı.", "user@test.com", true, "Sertap", false, "Erener", null, null, "CfDJ8Og5fv4kqcJInWpt0PuNFrqtlXdN2LYpeT1uk0J7ZlUjd3BuDR-RqTn-RJCNpVg5eyXtrylS9ehOJ_fLDZdH_NLX11cuStQtRO2kdY_7RSiqoFPhJlYZyE34dRYj1zDmjw", "0850", null, 2, true, new Guid("56c8cd90-080e-428e-b3c2-41a8208061b2"), "SertapErener" },
                    { 3, "Ankara", null, null, new DateTime(2024, 5, 16, 3, 58, 52, 798, DateTimeKind.Local).AddTicks(7130), null, "User Onaylandı.", "customer@test.com", true, "Levent", false, "Yüksel", null, null, "CfDJ8Og5fv4kqcJInWpt0PuNFrremUo2LZix_FrWzIesEfwYZYxesHDStiB7cvwbNB83iy7ZaSPufK3-oQC8aMLwqrQDGMQJCEl4LjBCoO-rGzyDD5lIcSLPkfuaZ6gWKscynw", "0850", null, 3, true, new Guid("4a80da17-fdec-4843-986a-095cb84948e1"), "LeventYuksel" }
                });
